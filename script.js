...
let score = 5;
let lettersFound = [false, false, false, false, false];
let lettersGuessed = [];
let hasPlayedToday = false;
let lastDatePlayed = 0;
let canPlay = false;
...
function saveData() {
  if (hasPlayedToday) {
    ...
    console.log("haven't played, no need to save")
  }
...
function checkWinLose(guess, tiles) {
  ...
  if (remainingTiles.length === 0) {
    showAlert("You win!" + '<br />' + `Score: ${score}` + '<br />' + `Word: ${targetWord.toUpperCase()}`, 5000)
    stopInteraction()
  }
}
